...
CryptoDEX Core version 1.2.1 is now available from:
...
- Fix for possible fork regarding zCDX
...
CryptoDEX will now be switching to a more standard semantic versioning
