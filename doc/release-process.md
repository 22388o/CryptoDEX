...
* Update translations, see [translation_process.md](https://github.com/cryptodexpay/cryptodex/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/cryptodexpay/gitian.sigs.git
...
### CryptoDex Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign CryptoDex Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit cryptodex=v${VERSION} ../cryptodex/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit cryptodex=v${VERSION} ../cryptodex/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit cryptodex=v${VERSION} ../cryptodex/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../cryptodex/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [cryptodex-detached-sigs](https://github.com/cryptodexpay/cryptodex-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the cryptodex.org server

- Update cryptodex.org

- Announce the release:

  - Release on CryptoDex forum: https://www.cryptodex.org/forum/topic/official-announcements.54/

  - CryptoDex-development mailing list

  - Update title of #cryptodexpay on Freenode IRC

  - Optionally reddit /r/CryptoDexpay, ... but this will usually sort out itself

- Notify flare so that he can start building [the PPAs](https://launchpad.net/~cryptodex.org/+archive/ubuntu/cryptodex)
