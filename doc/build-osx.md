...
If you are building `cryptodexd` or `cryptodex-qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the CryptoDEX-Qt.app
...
commands:
    ...
    echo -e "rpcuser=cryptodexrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/CryptoDEX/cryptodex.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/CryptoDEX/cryptodex.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/CryptoDEX/debug.log
...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure CryptoDEX with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the CryptoDEX wallet:
...
You have the choice to build the GUI CryptoDEX wallet as a Mac OSX app, described in “How to build the CryptoDEX-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the CryptoDEX-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find CryptoDEX-Qt.dmg inside your CryptoDEX folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/CryptoDEX/src/qt/cryptodex-qt