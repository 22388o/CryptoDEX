...
In order to support loading of multiple wallets in cryptodex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptodex.cpp.
...
Changes to cryptodex.cpp
----------------------
cryptodex.cpp is the entry point into cryptodex-qt, and as such, will require some minor modifications to provide hooks for
