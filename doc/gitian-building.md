...
*Setup instructions for a Gitian build of CryptoDex Core using a Debian VM or physical system.*
...
Clone the git repositories for CryptoDex Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cryptodexpay/cryptodex
```
...
in the CryptoDex Core repository under 'Fetch and build inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the CryptoDex Core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cryptodex/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/cryptodexpay/cryptodex
...
For example:
```bash
URL=https://github.com/crowning-/cryptodex.git
...
cd /some/root/path/
git clone https://github.com/cryptodexpay/cryptodex-detached-sigs.git

BTCPATH=/some/root/path/cryptodex.git
SIGPATH=/some/root/path/cryptodex-detached-sigs.git
...
[cryptodex/gitian.sigs](https://github.com/cryptodexpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
