...
This mechanism has been integrated into Bitcore-Node-CryptoDex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptodexpay/insight-api-cryptodex#web-socket-api](https://github.com/cryptodexpay/insight-api-cryptodex#web-socket-api)
* API: [https://github.com/cryptodexpay/insight-api-cryptodex#instantsend-transactions](https://github.com/cryptodexpay/insight-api-cryptodex#instantsend-transactions)
...
By default, the CryptoDex Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CryptoDex Core daemon:
