...
The CryptoDEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CryptoDEX Core project, and is not to be
confused with overall CryptoDEX Network Protocol consensus changes.

Whether a pull request is merged into CryptoDEX Core rests with the project merge
...
Patches that change CryptoDEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the CryptoDEX consensus, it must have been
