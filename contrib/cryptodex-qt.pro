...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cryptodex-cli.cpp \
           src/cryptodex-tx.cpp \
           src/cryptodex.cpp \
           src/db.cpp \
           ...
           src/qt/cryptodex.cpp \
           src/qt/cryptodexstrings.cpp \
...
RESOURCES += src/qt/cryptodex.qrc src/qt/cryptodex_locale.qrc

TRANSLATIONS += src/qt/locale/cryptodex_bg.ts \
                src/qt/locale/cryptodex_de.ts \
                src/qt/locale/cryptodex_en.ts \
                src/qt/locale/cryptodex_es.ts \
                src/qt/locale/cryptodex_fi.ts \
                src/qt/locale/cryptodex_fr.ts \
                src/qt/locale/cryptodex_it.ts \
                src/qt/locale/cryptodex_ja.ts \
                src/qt/locale/cryptodex_pl.ts \
                src/qt/locale/cryptodex_pt.ts \
                src/qt/locale/cryptodex_ru.ts \
                src/qt/locale/cryptodex_sk.ts \
                src/qt/locale/cryptodex_sv.ts \
                src/qt/locale/cryptodex_vi.ts \
                src/qt/locale/cryptodex_zh_CN.ts \
                src/qt/locale/cryptodex_zh_TW.ts
