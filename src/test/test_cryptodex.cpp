...
#define BOOST_TEST_MODULE CryptoDex Test Suite

#include "test_cryptodex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cryptodex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
