...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CryptoDexNetwork") type = CryptoDexNetwork;
    if(strType == "CryptoDexNetworkVariable") type = CryptoDexNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CryptoDexNetwork) s = "CryptoDexNetwork";
    if(type == CryptoDexNetworkVariable) s = "CryptoDexNetworkVariable";
