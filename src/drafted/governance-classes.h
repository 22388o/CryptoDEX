 ...
 *
 *   // network
 *   CCryptoDexNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cryptodex.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCryptoDexNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCryptoDexNetwork(UniValue objIn)
    {
...
// // can be under: CryptoDexNetwork
// //   -- signature requirements : Key1(User)
// class CCryptoDexNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CryptoDexNetwork);
//     // }
