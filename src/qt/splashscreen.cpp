    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextCryptoDex   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The CryptoDex Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextCryptoDex);
