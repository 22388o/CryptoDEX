...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoDEX Core"),
     ...
     * override -datadir in the cryptodex.conf file in the default data directory
     * (to be consistent with cryptodexd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
