    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CXD-light"), QVariant("light"));
    ui->theme->addItem(QString("CXD-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CXD-green"), QVariant("drkblue"));
    ui->theme->addItem(QString("CXD-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CXD-traditional"), QVariant("trad"));
