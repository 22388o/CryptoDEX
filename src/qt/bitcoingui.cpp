...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CryptoDex Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoDex Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CryptoDex Core help message to get a list with possible CryptoDex Core command-line options"));
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    ...
    // Append title to "CryptoDex Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
