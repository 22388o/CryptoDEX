                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoDEX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoDEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptodex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCDX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoDEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoDEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoDEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoDEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoDEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a CryptoDEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoDEX Core help message to get a list with possible CryptoDEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoDEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoDEX network", "", count));
}
...
{
    QString strTitle = tr("CryptoDEX Core"); // default title
