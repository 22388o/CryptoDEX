    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CryptoDex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CryptoDex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cryptodex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CryptoDex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CXD, 0.1 CXD, 1 CXD and 10 CXD -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cryptodexpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://cryptodexpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CryptoDex Core is shutting down...") + "<br /><br />" +
