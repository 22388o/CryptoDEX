...
/** Utility functions used by the CryptoDEX Qt UI.
 */
namespace GUIUtil
{
...
// Render CryptoDEX addresses in monospace font
...
// Parse "cryptodex:" URI into recipient object, return true on successful parsing
