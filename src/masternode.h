...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 10000 CXD, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 CXD - checking if valid masternode)
