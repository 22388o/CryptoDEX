...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemacryptodexGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemacryptodexGrant grantOutbound;
