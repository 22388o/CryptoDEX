...
2. run cryptodexd with -printalert or -sendalert like this:
   /path/to/cryptodexd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptodex.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CryptoDex Core:0.12.0.58/"));
