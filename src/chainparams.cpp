...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CryptoDEX: 1 day
        nTargetSpacing = 1 * 60;  // CryptoDEX: 1 minute
        nMaturity = 50;
        ...
        nZerocoinStartHeight = 99999999999;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CryptoDEX: 1 day
        nTargetSpacing = 1 * 10;  // CryptoDEX: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cryptodex addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cryptodex script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cryptodex BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptodex BIP32 prvkeys start with 'DRKP'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CryptoDEX: 1 day
        nTargetSpacing = 1 * 60;        // CryptoDEX: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1505224800;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
