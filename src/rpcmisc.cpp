...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total cryptodex balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zCDXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCDX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCDX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCDX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCDX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCDX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCDX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCDX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCDX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCDX denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in cryptodex/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in cryptodex/kb\n"
    ...
    obj.push_back(Pair("zCDXsupply", zphrObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"cryptodexaddress\"\n"
            "\nReturn information about the given cryptodex address.\n"
            "\nArguments:\n"
            "1. \"cryptodexaddress\"     (string, required) The cryptodex address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"cryptodexaddress\", (string) The cryptodex address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: CryptoDEX address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are cryptodex addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) cryptodex address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"cryptodexaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"cryptodexaddress\"  (string, required) The cryptodex address to use for the signature.\n"
